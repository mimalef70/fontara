...
The Firefox source package for review is generated by the same command and will
be written to:

```text
build/firefox-mv3-source-5.1.0.zip
```
...
from the source files in this package, then creates the Firefox add-on zip and
the Firefox source review zip.
