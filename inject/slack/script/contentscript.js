...
browser.storage.local.get(['font', 'slack'], function(items) {
...
browser.storage.onChanged.addListener(function(changes, namespace) {
  browser.storage.local.get(['font', 'slack', 'custom_fonts'], function(items) {
    ...
    if (changes.slack != undefined || changes.font != undefined) {
      if (items.slack == true) {
        document.documentElement.style.setProperty(`--font`, items.font);
      } else {
        document.documentElement.style.setProperty(`--font`, 'remove font');
