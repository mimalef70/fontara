      ...
      <div>
        ...
        <div className="relative">
          <div className="flex flex-col gap-3">
            ...
            >
              افزودن فونت دلخواه <svg className="size-5" id="Plus 2" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M12 3C16.9709 3 21 7.02908 21 12C21 16.9699 16.9709 21 12 21C7.02908 21 3 16.9699 3 12C3 7.02908 7.02908 3 12 3Z" stroke="#2374ff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M15.2989 12.002H8.69922" stroke="#2374ff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M12 8.70386V15.2967" stroke="#2374ff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
            </a>
          </div>
