...
browser.storage.local.get(['font', 'youtube'], function(items) {
  if (items.youtube == true || items.youtube == undefined) {
...
browser.storage.onChanged.addListener(function(changes, namespace) {
  browser.storage.local.get(['font', 'youtube', 'custom_fonts'], function(
    items
  ) {
    ...
    if (changes.youtube != undefined || changes.font != undefined) {
