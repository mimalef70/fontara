...
browser.storage.local.get(['font', 'messagesandroid'], function(items) {
  if (items.messagesandroid == true || items.messagesandroid == undefined) {
...
browser.storage.onChanged.addListener(function(changes, namespace) {
  browser.storage.local.get(
    ['font', 'messagesandroid', 'custom_fonts'],
    function(items) {
      ...
      if (changes.messagesandroid != undefined || changes.font != undefined) {
        if (items.messagesandroid == true) {
          document.documentElement.style.setProperty(`--font`, items.font);
        } else {
          document.documentElement.style.setProperty(`--font`, 'remove font');
        }
