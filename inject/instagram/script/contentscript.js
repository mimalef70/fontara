...
browser.storage.local.get(['font', 'instagram'], function(items) {
  if (items.instagram == true || items.instagram == undefined) {
...
browser.storage.onChanged.addListener(function(changes, namespace) {
  browser.storage.local.get(['font', 'instagram', 'custom_fonts'], function(
    items
  ) {
    ...
    if (changes.instagram != undefined || changes.font != undefined) {
