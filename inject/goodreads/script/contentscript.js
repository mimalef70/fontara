...
browser.storage.local.get(['font', 'goodreads'], function(items) {
...
browser.storage.onChanged.addListener(function(changes, namespace) {
  browser.storage.local.get(['font', 'goodreads', 'custom_fonts'], function(
    items
  ) {
    ...
    if (changes.goodreads != undefined || changes.font != undefined) {
