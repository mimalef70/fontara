...
browser.storage.local.get(['font', 'facebook'], function(items) {
  if (items.facebook == true || items.facebook == undefined) {
...
browser.storage.onChanged.addListener(function(changes, namespace) {
  browser.storage.local.get(['font', 'facebook', 'custom_fonts'], function(
    items
  ) {
    ...
    if (changes.facebook != undefined || changes.font != undefined) {
